...
| [`docs/IMPLEMENTATION_PLAN.md`](docs/IMPLEMENTATION_PLAN.md) | The work broken into 188 Steps across 20 phases (0–19) — 150 of scheduled work, 3 routed out to a separate repository, plus 35 named gaps (Phase 11) that gate nothing — each Step shippable as one pull request and referencing the technical-plan section that specifies it. |
