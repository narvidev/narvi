...
export interface PlatformAnalytics {
  ...
  windowDays: number;
  /**
   * Every session row created within the window, regardless of status -- INCLUDING a session created but never dispatched a single turn (session.StatusCreated). Always a real, meaningful count; 0 is a true fact for a brand-new deployment, never 'unknown'.
   */
