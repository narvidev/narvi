...
func TestValidateName(t *testing.T) {
	tests := []struct {
		...
		{"process hijack reserved ld_audit", "LD_AUDIT", ErrNameReservedProcessHijack},
		...
		{"process hijack reserved git_exec_path", "GIT_EXEC_PATH", ErrNameReservedProcessHijack},
