...
var stepRefPins = []stepRefPin{
	...
	{"docs/DECISIONS.md", "57", "RWX provider + previews"},
	{"docs/DECISIONS.md", "43", "warm boot: dependency-work reduction (3 PRs — (a)+(b)+(c) all shipped)"},
	{"docs/DECISIONS.md", "49", "handoff-readiness sentinel"},
	{"docs/DECISIONS.md", "63", "review: learned false-positive patterns"},
	{"docs/DECISIONS.md", "68", "review triage: deterministic light/deep routing"},
	{"docs/DECISIONS.md", "72", "sandbox secrets & opencode config"},
	{"docs/DECISIONS.md", "104", "shadow operator surface"},
	{"docs/DECISIONS.md", "184", "secrets reachable from a newly created automation"},
	...
	{"docs/DECISIONS.md", "48", "sentinels + suggestions"},
	{"docs/DECISIONS.md", "147", "self-correction before escalation, and the three failure modes"},
	{"docs/DECISIONS.md", "188", "human acceptance of a verdict the engine refuses"},
	{"docs/DECISIONS.md", "190", "GitHub's deadlines, honored end to end"},
	{"docs/DECISIONS.md", "196", "the operator surface and runbook"},
	{"docs/DECISIONS.md", "197", "a retried verdict delivery posts a second review"},
	...
	{"migrations/000131_turns_dispatched_message_id.up.sql", "173", "a review verdict does not know what it reviewed"},
}
